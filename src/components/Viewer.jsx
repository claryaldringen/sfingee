...
export default class Viewer extends React.Component {
	...
	render() {
		...
		if(this.props.index > 0) {
			...
			left = <div style={leftStyle} onClick={this.leftClick.bind(this)}><img src={LeftPng} width={32} height={32} /></div>
		}
		...
		if(this.props.index < this.props.images.length-1) {
			...
			right = <div style={rightStyle} onClick={this.rightClick.bind(this)}><img src={RightPng} width={32} height={32} /></div>
		...
		return(
			<div style={mainStyle}>
				...
				<div style={crossStyle} onClick={this.props.hideViewer}>
					<img src={CrossPng} width={32} height={32} />
				</div>
